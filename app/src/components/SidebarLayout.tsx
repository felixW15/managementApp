...
export function SidebarLayout({ onLogout, menuItems }: SidebarLayoutProps) {
 ...
 return (
  <div className="flex min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
    {/* Sidebar */}
    <aside className="w-42 bg-gray-100 dark:bg-gray-800 border-r dark:border-gray-700 p-4 flex flex-col justify-between">
      <nav>
    ...
    {/* Main content */}
    <main className="flex-1 p-6 bg-white dark:bg-gray-900">{activeComponent}</main>
  </div>
);
}
